...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-body">
                <form method="POST"
                    action="{{ route('admin.catalog.products.update', ['locale' => app()->getLocale(), 'product' => $product->id]) }}"
                    class="row g-3">
                    @csrf
                    @method('PUT')
                    <div class="col-md-6">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-check form-switch mt-2">
                            ...
                            <input class="form-check-input" type="checkbox" name="is_active" id="catalog_is_active_edit"
                                value="1" @checked(old('is_active', $product->is_active))>
                            <label class="form-check-label" for="catalog_is_active_edit">{{ __('Active') }}</label>
                        </div>
                        @error('is_active')
