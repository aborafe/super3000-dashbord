...
<html
  ...
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('sneat-bootstrap-html-admin-template-free/assets') }}/img/favicon/favicon.ico" />
    ...
    <link rel="stylesheet" href="{{ asset('sneat-bootstrap-html-admin-template-free/assets') }}/vendor/fonts/iconify-icons.css" />
    ...
    <link rel="stylesheet" href="{{ asset('sneat-bootstrap-html-admin-template-free/assets') }}/vendor/libs/perfect-scrollbar/perfect-scrollbar.css" />
  ...
  <body>
    ...
    <script src="{{ asset('sneat-bootstrap-html-admin-template-free/assets') }}/vendor/libs/perfect-scrollbar/perfect-scrollbar.js"></script>
